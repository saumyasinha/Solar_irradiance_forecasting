...
def main():
    ...
    for season_flag in seasons:
        ...
        f = open(folder_saving + season_flag + '/ML_models_2008/nn/results.txt', 'a')
        for lead in lead_times:
            ...
            if len(df_train)>0 and len(df_heldout)>0:
                ...
                reg = "nn_with_lag_features" ## giving a name to the regression models -- useful when saving results
