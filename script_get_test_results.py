...
# lead time
lead_times = [1,2,3,4,5,6,7] #from [1,2,3,4,5,6]
    ...
    for season_flag in seasons:
        ...
        for lead in lead_times:
            ...
            if len(df_train)>0 and len(df_heldout)>0:
                ...
                X_train, X_valid, X_test = preprocess.standardize_from_train(X_train=None, X_valid=None, X_test=X_heldout, folder_saving = folder_saving+season_flag + "/ML_models_2008/rf/modified_features/",model = reg, lead = lead)
                ...
                f.write('score on heldout data for year 2008' + reg + '=' + str(round(skill_sp, 1)) + '\n')
